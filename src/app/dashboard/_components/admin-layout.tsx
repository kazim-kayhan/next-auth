  ...
  return (
    <div>
      ...
      <div className='hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col'>
        {/* Sidebar component, swap this element with another sidebar if you like */}
        <div className='flex grow flex-col gap-y-5 overflow-y-auto border px-6  pb-4'>
          <div className='flex h-16 shrink-0 items-center'>
            <Logo className='h-8 w-auto' />
          </div>
          <nav className='flex flex-1 flex-col'>
      ...
      <div className='lg:pl-72'>
        <div className='sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border px-4  shadow-sm sm:gap-x-6 sm:px-6 lg:px-8'>
          <button
            type='button'
          ...
          <div className='flex flex-1 justify-between gap-x-4 self-stretch lg:gap-x-6'>
            <form className='relative my-auto flex max-w-sm flex-1 items-center'>
            ...
            <div className='flex items-center gap-x-4 lg:gap-x-6'>
              <Button className='rounded-full hover:text-foreground' size='sm' asChild>
                <Link href='/'>
                  <Monitor className='mr-2 size-4' /> Visit Site
                </Link>
              </Button>
              ...
              <Menu as='div' className='relative'>
                ...
                >
                  <Menu.Items className='absolute right-0 z-10 mt-2.5 w-32 origin-top-right space-y-1 rounded-md bg-background shadow-lg ring-1 ring-foreground/5 focus:outline-none'>
